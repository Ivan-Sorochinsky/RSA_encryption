...
'''
# Шифрование текста
# Каждому символу соответствует его порядковый номер в алфавите*10
# Дыра в безопасности! Нужно использовать другой метод подстановки! Например алгоритм Хилла
dictCodes = {chr(value+55):value for value in range(10,36)}
message = "programmer".upper()
